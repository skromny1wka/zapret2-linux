...
class HostsServicesCatalogWorkerArchitectureTests(unittest.TestCase):
    def test_services_catalog_worker_uses_commands_not_controller(self) -> None:
        ...
        self.assertIn("hosts_commands.build_services_catalog_plan", worker_source)
        self.assertIn("hosts_commands.get_catalog_signature", worker_source)
