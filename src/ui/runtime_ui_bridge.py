...
from ui.page_method_dispatch import (
    show_active_preset_setup_page_loading,
    show_active_preset_setup_page_success,
)
...
class RuntimeUiBridge:
    ...
    def show_active_preset_setup_page_loading(self) -> bool:
        return show_active_preset_setup_page_loading(self._window)

    def show_active_preset_setup_page_success(self) -> bool:
        return show_active_preset_setup_page_success(self._window)
